...
// If the number of arguments is not 1, or there are no words, simply display
// a newline.
...
// to run it : ./last_word "FOR PONY"
// to run it : ./last_word "this        ...       is sparta, then again, maybe    not"
// to run it : ./last_word "   "
// to run it : ./last_word "a" "b"
// to run it : ./last_word "  lorem,ipsum  "
//******************************************************
