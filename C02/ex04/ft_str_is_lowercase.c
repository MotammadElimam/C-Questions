 ...
 ******************************************************
 * to compile it : gcc ft_str_is_lowercase.c
 * to run it : ./a.out
 ******************************************************
 */
...
/**********************
 * ft_str_is_lowercase - Checks if string contains only lowercase alphabetical characters
 * 
 * Description:
 * This function examines each character in the given string to determine
 * if all characters are lowercase alphabetical letters (a-z). It returns 1
 * if the string contains only lowercase alphabetical characters, and 0 if
 ...
 * 4. If any character is not lowercase alphabetical, return 0 immediately
 * 5. If all characters are lowercase alphabetical (or string is empty), return 1
 * 
 * Parameters:
 * @str: Pointer to null-terminated string to be checked
 * 
 * Return:
 * int - 1 if string contains only lowercase alphabetical characters, 0 otherwise
 * 
 * Examples:
 * ft_str_is_lowercase("hello") returns 1
 * ft_str_is_lowercase("Hello") returns 0
 * ft_str_is_lowercase("hello123") returns 0
...
int	ft_str_is_lowercase(char *str)
{
	...
	{
		if (!(str[i] >= 'a' && str[i] <= 'z'))	/* Check if character is not lowercase */
		{
			return (0);				/* Return 0 if non-lowercase character found */
		}
...
/**********************
 * main - Entry point for lowercase string checker demonstration
 * 
 * Description:
 * This program demonstrates the ft_str_is_lowercase function by testing it
 * with various strings including lowercase-only strings, mixed case strings,
 * and edge cases. It displays the test results to show how the function
 * behaves with different inputs.
 * 
 * Algorithm:
 * 1. Test with purely lowercase strings
 ...
 * 
 * Examples:
 * ./ft_str_is_lowercase shows various string validation demonstrations
 **********************/
int main(void)
{
	ft_putstr("Testing ft_str_is_lowercase function:\n\n");	/* Display program header */
	
	/* Test case 1: Pure lowercase string */
	ft_putstr("Test 1 - \"hello\": ");						/* Test description */
	if (ft_str_is_lowercase("hello"))						/* Check if string is lowercase */
	...
	/* Test case 3: Lowercase with numbers */
	ft_putstr("Test 3 - \"hello123\": ");					/* Test description */
	if (ft_str_is_lowercase("hello123"))					/* Check if string is lowercase */
		ft_putstr("is lowercase\n");						/* Display positive result */
	else
		ft_putstr("is not lowercase\n");					/* Display negative result */
	...
	if (ft_str_is_lowercase(""))							/* Check if empty string is lowercase */
		ft_putstr("is lowercase\n");						/* Display positive result */
	else
		ft_putstr("is not lowercase\n");					/* Display negative result */
